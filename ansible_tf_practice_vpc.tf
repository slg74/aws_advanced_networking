...
# create an S3 bucket
resource "aws_s3_bucket" "ansible_tf_practice_bucket1" {
  bucket = "s3-bucket-ansible-tf-practice-0000000000000001"
}

# create an S3 bucket
resource "aws_s3_bucket" "ansible_tf_practice_bucket2" {
  bucket = "s3-bucket-ansible-tf-practice-0000000000000002"
}